    ...
    window.onload = function() {
        ...
        if (playVideo) {
            $("#play-video").on("click", (function(e) {
                ...
                $("#video-overlay").append('<iframe width="860" height="515" src="https://www.youtube.com/embed/sSY5HaXxTgI" frameborder="0" allow="accelerometer; autoplay=1; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>');
            }));
